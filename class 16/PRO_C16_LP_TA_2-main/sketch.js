...
function setup() {
  ...
  //X-offset/Y-offset --> the distance between the center of the sprite and collider radius along x-axis/y-axis
  ...
  gameOver.addImage("displayEnd",gameOverImg)
  gameOver.scale = 0.6
  
  restart = createSprite(300,150)
  restart.addImage("displayRestart",restartImg)
  restart.scale = 0.5
